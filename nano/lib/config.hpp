...
public:
		...
		work{ work }
	{
		...
		default_node_port = is_live_network () ? 7079 : is_beta_network () ? 54000
		: is_test_network ()                                               ? test_node_port ()
																		   : 44000;
		default_rpc_port = is_live_network () ? 7080 : is_beta_network () ? 55000
		: is_test_network ()                                              ? test_rpc_port ()
																		  : 45000;
		default_ipc_port = is_live_network () ? 7081 : is_beta_network () ? 56000
		: is_test_network ()                                              ? test_ipc_port ()
																		  : 46000;
		default_websocket_port = is_live_network () ? 7082 : is_beta_network () ? 57000
